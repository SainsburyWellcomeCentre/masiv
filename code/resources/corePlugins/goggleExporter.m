classdef goggleExporter<goggleBoxPlugin
    ...
    methods
        function obj=goggleExporter(caller, ~)
            ...
            try
                pos=gbSetting('exporter.figurePosition');
            catch
                ssz=get(0, 'ScreenSize');
                lb=[ssz(3)/3 ssz(4)/3];
                pos=round([lb 400 550]);
                gbSetting('exporter.figurePosition', pos)
            end
            ...
            switch class(obj.goggleViewer.mainDisplay.currentImageViewData)
                case 'uint8'
                    obj.h8Bit.Value=1;
                case 'uint16'
                    obj.h16Bit.Value=1;
            ...
            obj.hDestPath=uicontrol(...
                ...
                'FontName', obj.fontName, ...
                'FontSize', obj.fontSize, ...
                'String', gbSetting('defaultDirectory'));
        ...
        function doExport(obj)
            ...
            s.experimentName=t.experimentName;
            s.region=regionSpec;
            s.idx=idx;
            s.format=format;
            switch obj.hPnlDestination.SelectedObject.String
...
function setCurrentSlice(~,~,obj, boxToSet)
    boxToSet.String=obj.goggleViewer.mainDisplay.currentZPlaneOriginalVoxels;
    obj.updateInfo
end
